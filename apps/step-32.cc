  ...
  namespace LinearSolvers
  {
    ...
    public:
                  ...
                  const TrilinosWrappers::MPI::BlockVector &src) const
      {
        ...
        {
          SolverControl solver_control(5000, 1e-6 );
    ...
    public:
      ...
      void vmult (TrilinosWrappers::MPI::BlockVector       &dst,
                  const TrilinosWrappers::MPI::BlockVector &src) const
      {
        static TrilinosWrappers::MPI::Vector utmp(src.block(0));

        {
          static SolverControl solver_control(5000, 1e-6);

          static SolverCG<TrilinosWrappers::MPI::Vector> solver(solver_control);
